...
knowledge0 = And(
    ...
    Or(And(AKnave, AKnight), Not(And(AKnave, AKnight))),
...
knowledge2 = And(
    And(Or(AKnight, AKnave), Not(And(AKnave, AKnight))),
    And(Or(BKnight, BKnave), Not(And(BKnave, BKnight))),
    Or(Or(And(AKnave, BKnave), And(AKnight, BKnight)), Not(Or(And(AKnave, BKnave), And(AKnight, BKnight)))),
    ...
    Or(Or(And(AKnave, BKnight), And(AKnight, BKnave)), Not(Or(And(AKnave, BKnight), And(AKnight, BKnave)))),
...
knowledge3 = And(
    ...
    Or(Or(Or(AKnight, AKnave), Not(And(AKnave, AKnight))), Not(Or(Or(AKnight, AKnave), Not(And(AKnave, AKnight))))),
